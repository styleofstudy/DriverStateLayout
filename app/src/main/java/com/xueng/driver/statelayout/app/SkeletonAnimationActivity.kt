...
import com.xueng.driver.statelayout.app.databinding.ActivitySkeletonMainBinding
import kotlin.concurrent.thread

class SkeletonAnimationActivity : DriverBaseActivity<ActivitySkeletonMainBinding>(R.layout.activity_skeleton_main) {
